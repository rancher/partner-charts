...
```console
wget https://github.com/nutanix/helm-releases/releases/download/nutanix-csi-storage-3.7.2/nutanix-csi-storage-3.7.2.tgz
```

After downloading the chart you can directly set the values and install:

```console
helm install nutanix-csi nutanix-csi-storage-3.7.2.tgz --set <key>=<value> -n <namespace of your choice>
```

Or you can unzip, set values and then install:

```console
tar -xvf nutanix-csi-storage-3.7.2.tgz

helm install nutanix-csi nutanix-csi-storage-3.7.2 -n <namespace of your choice>
```
...
```console
helm upgrade nutanix-csi nutanix-csi-storage-3.7.2.tgz --set <key>=<value> -n <namespace of your choice>
```
