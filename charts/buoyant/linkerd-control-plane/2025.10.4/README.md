...
![Version: 2025.10.4](https://img.shields.io/badge/Version-2025.10.4-informational?style=flat-square)
...
| controller.tracing.collector.endpoint | string | `""` | The collector endpoint to send traces to. Required if tracing is enabled |
