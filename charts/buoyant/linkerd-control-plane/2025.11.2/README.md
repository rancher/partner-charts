...
![Version: 2025.11.2](https://img.shields.io/badge/Version-2025.11.2-informational?style=flat-square)
...
| proxy.nativeSidecar | bool | `false` | Enable KEP-753 native sidecars This is a beta feature. It requires Kubernetes >= 1.29. If enabled, .proxy.waitBeforeExitSeconds should not be used. |
...
| proxyInit.image.version | string | `"v2.4.3"` | Tag for the proxy-init container image |
