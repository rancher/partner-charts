...
|-----|------|---------|-------------|
| installGatewayAPI | bool | `true` | Controls if Linkerd should install the Gateway API CRDs. This value acts as a default and can be overridden by the more specific `enable*Routes` values. |
