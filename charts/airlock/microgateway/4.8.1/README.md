...
![Version: 4.8.1](https://img.shields.io/badge/Version-4.8.1-informational?style=flat-square) ![AppVersion: 4.8.1](https://img.shields.io/badge/AppVersion-4.8.1-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.8.1).__
...
1. Install the CNI Plugin with Helm.
   ...
   helm install airlock-microgateway-cni \
     ...
     --version '4.8.1' \
     -n kube-system \
     -f https://raw.githubusercontent.com/airlock/microgateway/4.8.1/deploy/charts/airlock-microgateway-cni/gke-values.yaml
...
| image.digest | string | `"sha256:d282b65f2d9090d33afc05574a9705d7431dc244eb3b12b0d9aefc5fd2c5f3d2"` | SHA256 image digest to pull (in the format "sha256:7144f7bab3d4c2648d7e59409f15ec52a18006a128c733fcff20d3a4a54ba44a"). Overrides tag when specified. |
...
| image.tag | string | `"4.8.1"` | Image tag to pull. |
