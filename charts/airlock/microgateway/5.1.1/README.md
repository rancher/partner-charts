...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/5.1.1).__
...
| config.engineImage.digest | string | `"sha256:8fd3f9aba166f15a6d41fd79f1754c4349df2a97df665c3ce65a7986762cf1b9"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.engineImage.tag | string | `"5.1.1"` | Image tag to pull. |
...
| config.sessionAgentImage.digest | string | `"sha256:b7fff0b493c2fd43298fe8f865b614a0abd8e1b59a076caef32ad3046f6ac9f7"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.sessionAgentImage.tag | string | `"5.1.1"` | Image tag to pull. |
...
| image.digest | string | `"sha256:29cfd6c43c9bd529e1dfea03ee974c131b7ccf11d3a359e1595de6f7b2d62516"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| image.tag | string | `"5.1.1"` | Image tag to pull. |
