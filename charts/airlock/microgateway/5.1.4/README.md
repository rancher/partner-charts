...
[![Release](https://img.shields.io/badge/Release-v5.1.4-6bba62)](https://github.com/airlock/microgateway/releases/tag/5.1.4)
...
[![GitHub](https://img.shields.io/badge/GitHub-Published-6bba62?logo=github&logoColor=white)](https://github.com/airlock/microgateway/releases/tag/5.1.4)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/5.1.4).__
...
| config.engineImage.digest | string | `"sha256:e03be634544f2aaa9dfebd3cd893afac3a9cd24d81ac216771852a25ac62ee1a"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.engineImage.tag | string | `"5.1.4"` | Image tag to pull. |
...
| config.sessionAgentImage.digest | string | `"sha256:0399f2c2c730484879aa52c5ab3d071079e9cc6672a635fda188944258bceef7"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.sessionAgentImage.tag | string | `"5.1.4"` | Image tag to pull. |
...
| image.digest | string | `"sha256:9cb3c9d81e61de9a83b53a3d5e4a00d20b1d8f6dfb863df198cc52c5928a4e62"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| image.tag | string | `"5.1.4"` | Image tag to pull. |
