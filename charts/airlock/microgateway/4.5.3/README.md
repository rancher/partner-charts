...
| image.digest | string | `"sha256:a657262973194e2f7ef94899fd7586fbeb83e3d3ccae4215590bbcca9cfd8715"` | SHA256 image digest to pull (in the format "sha256:7144f7bab3d4c2648d7e59409f15ec52a18006a128c733fcff20d3a4a54ba44a"). Overrides tag when specified. |
...
| image.tag | string | `"4.5.3"` | Image tag to pull. |
