...
[![Release](https://img.shields.io/badge/Release-v5.0.3-6bba62)](https://github.com/airlock/microgateway/releases/tag/5.0.3)
...
[![GitHub](https://img.shields.io/badge/GitHub-Published-6bba62?logo=github&logoColor=white)](https://github.com/airlock/microgateway/releases/tag/5.0.3)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/5.0.3).__
...
```console
kubectl apply -k https://github.com/airlock/microgateway/deploy/charts/airlock-microgateway/crds/?ref=5.0.3 \
  --server-side \
  --force-conflicts
```
...
| config.engineImage.digest | string | `"sha256:20ccf226b7b78bd3dd56cb0743e38a2c628748286f39ba6b1154199ee5348282"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.engineImage.tag | string | `"5.0.3"` | Image tag to pull. |
...
| config.sessionAgentImage.digest | string | `"sha256:6f3ca8be4b69a6af41e315a271d7a9868eddc0f676a386a80b02f2f43ee29088"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.sessionAgentImage.tag | string | `"5.0.3"` | Image tag to pull. |
...
| image.digest | string | `"sha256:385d819b611a17fbd4ad3adecfbc99b4d79680f132c1a11a9e0556b85c8ab6fb"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| image.tag | string | `"5.0.3"` | Image tag to pull. |
