...
[![Release](https://img.shields.io/badge/Release-v5.1.5-6bba62)](https://github.com/airlock/microgateway/releases/tag/5.1.5)
...
[![GitHub](https://img.shields.io/badge/GitHub-Published-6bba62?logo=github&logoColor=white)](https://github.com/airlock/microgateway/releases/tag/5.1.5)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/5.1.5).__
...
| config.engineImage.digest | string | `"sha256:74efb34b454d4b7a31039adfbc8484100e51518f96312257539c2396274c6c22"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.engineImage.tag | string | `"5.1.5"` | Image tag to pull. |
...
| config.sessionAgentImage.digest | string | `"sha256:96a56952bf399321e0b0d2d22d71916a7d42ed243461194a413cd414144be9d4"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.sessionAgentImage.tag | string | `"5.1.5"` | Image tag to pull. |
...
| image.digest | string | `"sha256:aa413447d74f66ace5f0c3fa42112d044699b11340900748d1daeb7bec337e68"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| image.tag | string | `"5.1.5"` | Image tag to pull. |
