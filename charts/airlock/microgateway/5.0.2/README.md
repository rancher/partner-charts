...
[![Release](https://img.shields.io/badge/Release-v5.0.2-6bba62)](https://github.com/airlock/microgateway/releases/tag/5.0.2)
...
[![GitHub](https://img.shields.io/badge/GitHub-Published-6bba62?logo=github&logoColor=white)](https://github.com/airlock/microgateway/releases/tag/5.0.2)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/5.0.2).__
...
```console
kubectl apply -k https://github.com/airlock/microgateway/deploy/charts/airlock-microgateway/crds/?ref=5.0.2 \
  --server-side \
  --force-conflicts
```
...
| config.engineImage.digest | string | `"sha256:7b09d5d9d3b20121928c0ac6ab3f54560c6baa846f8043f90d83c187b7fde6c9"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.engineImage.tag | string | `"5.0.2"` | Image tag to pull. |
...
| config.sessionAgentImage.digest | string | `"sha256:92ddd510b9c19156fa1e32ef1131a0665d3345455acfc3bf884ea658593a1084"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.sessionAgentImage.tag | string | `"5.0.2"` | Image tag to pull. |
...
| image.digest | string | `"sha256:15a2d26a13146fd68c0a4a9855d96505e14d5437701c173be5fc33bf9e9f68fc"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| image.tag | string | `"5.0.2"` | Image tag to pull. |
