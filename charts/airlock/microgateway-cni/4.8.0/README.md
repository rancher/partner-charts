# DEPRECATED - Airlock Microgateway CNI
> **:exclamation: This Helm Chart is deprecated!**

__This chart has been deprecated. Microgateway 4.8 is the final release with sidecar support which requires the Airlock Microgateway CNI plugin.
This release will be supported for 9 months from publication.__

__Future Airlock Microgateway releases will only support the sidecarless architecture based on the [Kubernetes Gateway API](https://docs.airlock.com/microgateway/4.8/index/1725073468781.html).__

__If you need further assistance, please contact order@airlock.com.__

![Version: 4.8.0](https://img.shields.io/badge/Version-4.8.0-informational?style=flat-square) ![AppVersion: 4.8.0](https://img.shields.io/badge/AppVersion-4.8.0-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.8.0).__
...
1. Install the CNI Plugin with Helm.
   ...
   helm install airlock-microgateway-cni \
     ...
     --version '4.8.0' \
     -n kube-system \
     -f https://raw.githubusercontent.com/airlock/microgateway/4.8.0/deploy/charts/airlock-microgateway-cni/gke-values.yaml
...
| image.digest | string | `"sha256:7fdd86364da608ee108cf2eece7776a416402ab09c31359057328aa0244c750e"` | SHA256 image digest to pull (in the format "sha256:7144f7bab3d4c2648d7e59409f15ec52a18006a128c733fcff20d3a4a54ba44a"). Overrides tag when specified. |
...
| image.tag | string | `"4.8.0"` | Image tag to pull. |
