...
{{- define "k10.restServices" -}}admin auth bloblifecyclemanager catalog controllermanager crypto dashboardbff events executor garbagecollector jobs logging metering mccontrollermanager state vbrintegrationapi {{- end -}}
{{- define "k10.services" -}}aggregatedapis {{- end -}}
{{- define "k10.exposedServices" -}}auth dashboardbff vbrintegrationapi {{- end -}}
{{- define "k10.statelessServices" -}}admin aggregatedapis auth bloblifecyclemanager controllermanager crypto dashboardbff events executor garbagecollector mccontrollermanager state vbrintegrationapi {{- end -}}
...
{{- define "k10.defaultK10GCDaemonPeriod" -}}1800{{- end -}}
...
{{- define "k10.kanisterToolsImageTag" -}}0.82.0{{- end -}}
