...
{{- define "k10.restServices" -}}admin auth bloblifecyclemanager catalog crypto dashboardbff events executor jobs logging metering mccontrollermanager state vbrintegrationapi {{- end -}}
{{- define "k10.services" -}}aggregatedapis config {{- end -}}
{{- define "k10.exposedServices" -}}auth dashboardbff vbrintegrationapi {{- end -}}
{{- define "k10.statelessServices" -}}admin aggregatedapis auth bloblifecyclemanager crypto dashboardbff events executor mccontrollermanager state vbrintegrationapi {{- end -}}
...
{{- define "k10.ambassadorImageTag" -}}2.2.2{{- end -}}
{{- define "k10.kanisterToolsImageTag" -}}0.79.0{{- end -}}
