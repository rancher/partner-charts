...
{{- define "k8s-triliovault-operator.frvm-registry" }}
{{- if eq .Values.registry  "gcr.io/amazing-chalice-243510"}}
{{- printf "%s" "eu.gcr.io/amazing-chalice-243510"}}
{{- else }}
...
{{- define "workerJobsSchedulingConfigExists" -}}
{{- if and .Values.workerJobsSchedulingConfig (kindIs "map" .Values.workerJobsSchedulingConfig) -}}
  {{- if or
      (hasKey .Values.workerJobsSchedulingConfig "affinity")
      (hasKey .Values.workerJobsSchedulingConfig "nodeSelector")
      (hasKey .Values.workerJobsSchedulingConfig "tolerations")
      (hasKey .Values.workerJobsSchedulingConfig "topologySpreadConstraints") -}}
    true
  {{- else -}}
    false
  {{- end -}}
