...
$ helm install -n triggermesh triggermesh-core triggermesh/triggermesh-core --create-namespace
```
...
This chart installs the [TriggerMesh Core Open Source Components](https://github.com/triggermesh/triggermesh-core) on a Kubernetes cluster.
...
```console
$ helm install --name my-release triggermesh/triggermesh-core
```
