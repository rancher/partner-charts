...
{{- $_32_____additionalEnv := (get (fromJson (include "redpanda.ClusterConfiguration.Translate" (dict "a" (list (deepCopy $values.config.extraClusterConfiguration))))) "r") -}}
