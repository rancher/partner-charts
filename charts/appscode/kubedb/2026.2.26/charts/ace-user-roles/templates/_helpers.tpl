...
*/}}
{{- define "ace-user-roles.fullname" -}}
...
Common labels
*/}}
{{- define "ace-user-roles.labels" -}}
helm.sh/chart: {{ include "ace-user-roles.chart" . }}
{{ include "ace-user-roles.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ace-user-roles.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ace-user-roles.name" . }}
...
*/}}
{{- define "ace-user-roles.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ace-user-roles.fullname" .) .Values.serviceAccount.name }}
{{- else }}
