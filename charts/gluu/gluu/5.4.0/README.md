...
|  | admin-ui | 5.4.0 |
|  | auth-server | 1.4.0 |
|  | auth-server-key-rotation | 1.4.0 |
|  | casa | 1.4.0 |
|  | cn-istio-ingress | 1.4.0 |
|  | config | 1.4.0 |
|  | config-api | 1.4.0 |
|  | fido2 | 1.4.0 |
|  | kc-scheduler | 1.4.0 |
...
| admin-ui.image.tag | string | `"5.4.0-1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| kc-scheduler | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/kc-scheduler","tag":"1.4.0-1"},"interval":10,"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Responsible for synchronizing Keycloak SAML clients |
...
| link.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.4.0-1"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| saml.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.4.0-1"` | Image  tag to use for deploying. |
