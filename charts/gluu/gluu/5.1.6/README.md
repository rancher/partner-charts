...
![Version: 5.1.6](https://img.shields.io/badge/Version-5.1.6-informational?style=flat-square) ![AppVersion: 5.1.6](https://img.shields.io/badge/AppVersion-5.1.6-informational?style=flat-square)
...
| admin-ui.image.tag | string | `"5.1.6-1"` | Image  tag to use for deploying. |
