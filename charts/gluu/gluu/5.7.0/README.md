...
![Version: 5.7.0](https://img.shields.io/badge/Version-5.7.0-informational?style=flat-square) ![AppVersion: 5.7.0](https://img.shields.io/badge/AppVersion-5.7.0-informational?style=flat-square)
...
|  | admin-ui | 5.7.0 |
|  | auth-server | 1.7.0 |
|  | auth-server-key-rotation | 1.7.0 |
|  | casa | 1.7.0 |
|  | cleanup | 1.7.0 |
|  | cn-istio-ingress | 1.7.0 |
|  | config | 1.7.0 |
|  | config-api | 1.7.0 |
|  | fido2 | 1.7.0 |
|  | kc-scheduler | 1.7.0 |
...
| admin-ui.image.tag | string | `"5.7.0-1"` | Image  tag to use for deploying. |
...
| auth-server-key-rotation.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"1.7.0-1"},"interval":60,"lifecycle":{},"limit":1000,"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| cleanup.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| global.link.customAnnotations | object | `{"deployment":{},"destinationRule":{},"horizontalPodAutoscaler":{},"pod":{},"podDisruptionBudget":{},"service":{},"virtualService":{}}` | Add custom annotations for kubernetes resources for the service |
| global.link.enabled | bool | `true` | Boolean flag to enable/disable the link chart. |
...
| kc-scheduler | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"1.7.0-1"},"interval":10,"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Responsible for synchronizing Keycloak SAML clients |
...
| kc-scheduler.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| keycloak-link.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| link.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| link.tolerations | list | `[]` | Add tolerations for the pods |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.7.0-1"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| saml.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.7.0-1"` | Image  tag to use for deploying. |
