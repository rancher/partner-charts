...
|  | admin-ui | 6.1.0 |
|  | auth-server | 2.1.0 |
|  | auth-server-key-rotation | 2.1.0 |
|  | casa | 2.1.0 |
|  | cleanup | 2.1.0 |
|  | cn-istio-ingress | 2.1.0 |
|  | config | 2.1.0 |
|  | config-api | 2.1.0 |
|  | fido2 | 2.1.0 |
|  | gateway-api | 2.1.0 |
...
| admin-ui.image.tag | string | `"6.1.0-1"` | Image  tag to use for deploying. |
...
| auth-server-key-rotation.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"2.1.0-1"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| cleanup.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
...
| gateway-api.gateway | object | `{"annotations":{},"attachLbIp":false,"caCert":"","className":"nginx","enabled":true,"httpPort":80,"httpsPort":443,"infrastructure":{"annotations":{},"labels":{},"parametersRef":{}},"labels":{},"name":"gluu-gateway","tlsSecretName":"tls-certificate","verifyClientCertProtection":false}` | Configuration for Gateway resource |
...
| gateway-api.routes | object | `{"annotations":{},"gatewayNamespace":"","httpSectionName":"http","httpsSectionName":"https","labels":{}}` | Configuration for HTTPRoute and its related resources |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/gluufederation/flex/persistence-loader","tag":"6.1.0-1"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"6.1.0-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"2.1.0-1"` | Image  tag to use for deploying. |
