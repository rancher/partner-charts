...
| image.repository | string | `"ghcr.io/gluufederation/flex/persistence-loader"` | Image  to use for deploying. |
| image.tag | string | `"6.1.0-1"` | Image  tag to use for deploying. |
