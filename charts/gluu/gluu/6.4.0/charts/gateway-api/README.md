...
* <https://github.com/GluuFederation/flex/tree/main/charts/gluu/charts/gateway-api>
...
|-----|------|---------|-------------|
| additionalConfig | object | `{"airlock":{"createLbService":false},"cilium":{"ipPoolBlocks":[]},"envoy":{"createGatewayClass":false},"istio":{},"kgateway":{},"nginx":{"enableAuditGrpcRewriteSnippets":false,"enableClientCertSnippets":false},"traefik":{}}` | Additional configuration for Specific Gateway API implementation |
...
| additionalConfig.nginx | object | `{"enableAuditGrpcRewriteSnippets":false,"enableClientCertSnippets":false}` | Configuration for NGINX Fabric. |
...
| gateway.caCert | string | `""` | Base64-encoded string of CA certificate used to sign client/server certificate. Required if using client cert authentication. |
...
| gateway.infrastructure.parametersRef | object | `{}` | Specific parametersRef for the infrastructure |
