...
|  | admin-ui | 6.2.0 |
|  | auth-server | 6.2.0 |
|  | auth-server-key-rotation | 6.2.0 |
|  | casa | 6.2.0 |
|  | cleanup | 6.2.0 |
|  | cn-istio-ingress | 6.2.0 |
|  | config | 6.2.0 |
|  | config-api | 6.2.0 |
|  | fido2 | 6.2.0 |
|  | gateway-api | 6.2.0 |
...
| admin-ui.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| auth-server-key-rotation.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"6.2.0"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| cleanup.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/gluufederation/flex/persistence-loader","tag":"6.2.0"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"6.2.0"` | Image  tag to use for deploying. |
