...
|  | admin-ui | 5.15.0 |
|  | auth-server | 1.15.0 |
|  | auth-server-key-rotation | 1.15.0 |
|  | casa | 1.15.0 |
|  | cleanup | 1.15.0 |
|  | cn-istio-ingress | 1.15.0 |
|  | config | 1.15.0 |
|  | config-api | 1.15.0 |
|  | fido2 | 1.15.0 |
|  | kc-scheduler | 1.15.0 |
|  | nginx-ingress | 1.15.0 |
|  | persistence | 1.15.0 |
|  | saml | 1.15.0 |
|  | scim | 1.15.0 |
...
| admin-ui.image.tag | string | `"5.15.0-1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"1.15.0-1"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| config-api.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
...
| kc-scheduler | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"1.15.0-1"},"interval":10,"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Responsible for synchronizing Keycloak SAML clients |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.15.0-1"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
...
| saml.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.15.0-1"` | Image  tag to use for deploying. |
