...
![Version: 6.4.1](https://img.shields.io/badge/Version-6.4.1-informational?style=flat-square) ![AppVersion: 6.4.1](https://img.shields.io/badge/AppVersion-6.4.1-informational?style=flat-square)
...
|  | admin-ui | 6.4.1 |
|  | auth-server | 6.4.1 |
|  | auth-server-key-rotation | 6.4.1 |
|  | casa | 6.4.1 |
|  | cleanup | 6.4.1 |
|  | cn-istio-ingress | 6.4.1 |
|  | config | 6.4.1 |
|  | config-api | 6.4.1 |
|  | fido2 | 6.4.1 |
|  | gateway-api | 6.4.1 |
...
| admin-ui.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| auth-server-key-rotation.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"6.4.1"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| cleanup.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/gluufederation/flex/persistence-loader","tag":"6.4.1"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"6.4.1"` | Image  tag to use for deploying. |
