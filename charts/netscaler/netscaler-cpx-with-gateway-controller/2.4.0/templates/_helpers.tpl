{{- define "netscaler-cpx-gateway-controller.name" -}}
...
*/}}
{{- define "netscaler-cpx-gateway-controller.fullname" -}}
...
*/}}
{{- define "netscaler-cpx-gateway-controller.chart" -}}
...
*/}}
{{- define "netscaler-cpx-gateway-controller.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "netscaler-cpx-gateway-controller.fullname" .) .Values.serviceAccount.name  | trunc 253 }}
{{- else -}}
    {{ default "default" .Values.serviceAccount.name | trunc 253 }}
{{- end -}}
{{- end -}}
