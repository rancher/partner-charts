...
| `k8s_sensor.deployment.enabled`                     | Isolate k8sensor with a deployment (does not support http, this setting can be overiden by `kubernetes.deployment.enabled=true` proxy)                                                                                                                                                                                                                                                             | `true`                                                                                                                                 |
