...
| `controllerManager.pod.tolerations`                             | Tolerations to influence controller manager pod assignment. See [Taints and Tolerations](https://kubernetes.io/docs/concepts/configuration/taint-and-toleration/)                                                                              | `nil`                                                                                                                                   |
