...
| checksAgent.image.tag | string | `"98a3fa1c"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"98a3fa1c"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"98a3fa1c"` | Default container image tag. |
