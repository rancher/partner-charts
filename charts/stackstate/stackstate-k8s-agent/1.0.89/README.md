...
Current chart version is `1.0.89`
...
| checksAgent.image.tag | string | `"1e287e80"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"1e287e80"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"1e287e80"` | Default container image tag. |
