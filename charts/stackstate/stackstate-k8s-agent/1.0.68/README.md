...
Current chart version is `1.0.68`
...
| checksAgent.image.tag | string | `"ac39a29d"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"ac39a29d"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"ac39a29d"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"718e9ab3"` | Default process-agent container image tag. |
