...
![Version: 2.8.8](https://img.shields.io/badge/Version-2.8.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.8.8](https://img.shields.io/badge/AppVersion-v2.8.8-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.8.8"` | CSI driver version |
...
| images.csidriverTag | string | `"2.8.8"` | CSI driver tag |
