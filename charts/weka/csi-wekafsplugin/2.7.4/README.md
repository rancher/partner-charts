...
![Version: 2.7.4](https://img.shields.io/badge/Version-2.7.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.7.4](https://img.shields.io/badge/AppVersion-v2.7.4-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.7.4"` | CSI driver version |
...
| images.registrarsidecar | string | `"registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.13.0"` | CSI registrar sidercar |
...
| images.csidriverTag | string | `"2.7.4"` | CSI driver tag |
