...
![Version: 2.7.5](https://img.shields.io/badge/Version-2.7.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.7.5](https://img.shields.io/badge/AppVersion-v2.7.5-informational?style=flat-square)
...
| csiDriverVersion | string | `"2.7.5"` | CSI driver version |
...
| images.csidriverTag | string | `"2.7.5"` | CSI driver tag |
