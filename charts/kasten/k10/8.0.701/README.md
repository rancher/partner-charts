...
`global.resources.[requests\|limits]` | Global resource requests and limits for K10 pods deployed by the chart (except Prometheus - see `prometheus.resources`) | `None`
