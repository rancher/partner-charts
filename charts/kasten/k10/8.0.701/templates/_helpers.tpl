...
{{- define "get.ClientIdForAzureMarketplace" -}}
     {{- print .Values.Azure.Identity.ClientId }}
{{- end }}
...
{{- end }}
{{- if .main.Values.global.resources.requests }}
  {{- $resourceValue = merge (dict "requests" .main.Values.global.resources.requests) $resourceValue }}
{{- end }}
{{- if .main.Values.global.resources.limits }}
  {{- $resourceValue = merge (dict "limits" .main.Values.global.resources.limits) $resourceValue }}
{{- end }}
...
{{- else if not (quote .Values.global.resources.requests.memory | empty) }}
WorkerPodMetricSidecarMemoryRequest: {{ .Values.global.resources.requests.memory | quote }}
{{- end }}
{{- if not (quote (index .Values.workerPodMetricSidecar.resources.requests "ephemeral-storage") | empty) }}
WorkerPodMetricSidecarEphemeralStorageRequest: {{ (index .Values.workerPodMetricSidecar.resources.requests "ephemeral-storage") | quote }}
{{- else if not (quote (index .Values.global.resources.requests "ephemeral-storage") | empty) }}
WorkerPodMetricSidecarEphemeralStorageRequest: {{ (index .Values.global.resources.requests "ephemeral-storage") | quote }}
{{- end }}
...
{{- else if not (quote .Values.global.resources.requests.cpu | empty) }}
WorkerPodMetricSidecarCPURequest: {{ .Values.global.resources.requests.cpu | quote }}
{{- end }}
...
{{- else if not (quote .Values.global.resources.limits.memory | empty) }}
WorkerPodMetricSidecarMemoryLimit: {{ .Values.global.resources.limits.memory | quote }}
{{- end }}
...
{{- else if not (quote .Values.global.resources.limits.cpu | empty) }}
WorkerPodMetricSidecarCPULimit: {{ .Values.global.resources.limits.cpu | quote }}
{{- end }}
{{- if not (quote (index .Values.workerPodMetricSidecar.resources.limits "ephemeral-storage") | empty) }}
WorkerPodMetricSidecarEphemeralStorageLimit: {{ (index .Values.workerPodMetricSidecar.resources.limits "ephemeral-storage") | quote }}
{{- else if not (quote (index .Values.global.resources.limits "ephemeral-storage") | empty) }}
WorkerPodMetricSidecarEphemeralStorageLimit: {{ (index .Values.global.resources.limits "ephemeral-storage") | quote }}
{{- end }}
{{- end }}
