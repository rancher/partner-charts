...
{{- if .Values.opentelemetry.traces.enabled }}
    {{- if not .Values.opentelemetry.traces.tracesEndpoint }}
        {{- fail "OpenTelemetry tracing is enabled but tracesEndpoint is not set. Please provide opentelemetry.traces.tracesEndpoint or disable tracing with opentelemetry.traces.enabled=false" }}
    {{- end }}
          - name: OTEL_EXPORTER_OTLP_TRACES_ENDPOINT
            value: {{ .Values.opentelemetry.traces.tracesEndpoint }}
    {{- if .Values.opentelemetry.traces.tracesSampler }}
          - name: OTEL_TRACES_SAMPLER
            value: {{ .Values.opentelemetry.traces.tracesSampler }}
    {{- end }}
    {{- if .Values.opentelemetry.traces.tracesSamplerArg }}
          - name: OTEL_TRACES_SAMPLER_ARG
            value: {{ .Values.opentelemetry.traces.tracesSamplerArg | quote }}
    {{- end }}
{{- end }}
