...
{{- define "k10.statelessServices" -}}aggregatedapis auth bloblifecyclemanager controllermanager crypto dashboardbff events executor garbagecollector insights repositories gateway state vbrintegrationapi{{- end -}}
...
{{- define "k10.defaultK10CatalogOperationsBatchLimit" -}}100{{- end -}}
...
{{- define "k10.defaultK10LimiterVolumeRetiresPerCluster" -}}10{{- end -}}
{{- define "k10.defaultK10LimiterDirectSnapshotsPerCluster" -}}10{{- end -}}
{{- define "k10.defaultK10LimiterVMSnapshotsPerCluster" -}}1{{- end -}}
{{- define "k10.defaultK10LimiterVMBackupsPerCluster" -}}3{{- end -}}
...
{{- define "k10.defaultK10ClientQPS" -}}50{{- end -}}
{{- define "k10.defaultK10ClientBurst" -}}100{{- end -}}
...
{{- define "k10.defaultK10TimeoutBackup" -}}45{{- end -}}
{{- define "k10.defaultK10TimeoutRestore" -}}600{{- end -}}
{{- define "k10.defaultK10TimeoutRetire" -}}45{{- end -}}
{{- define "k10.defaultK10TimeoutBlueprintResourceHooks" -}}20{{- end -}}
...
{{- define "k10.kanisterToolsImageTag" -}}0.119.0{{- end -}}
...
{{- define "k10.datamoverAPIs" -}}datamover{{- end -}}
{{- define "k10.FRSessionCR" -}}filerecoverysessions{{- end -}}
