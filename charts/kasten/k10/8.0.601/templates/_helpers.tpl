...
{{/*
Get the flrsession image.
*/}}
{{- define "get.flrsessionImage" }}
  {{- (get .Values.global.images (include "k10.flrsessionImageName" .)) | default (include "k10.flrsessionImage" .)  }}
{{- end }}

{{- define "k10.flrsessionImage" -}}
  {{- printf "%s:%s" (include "k10.flrsessionImageRepo" .) (include "k10.flrsessionImageTag" .) }}
{{- end -}}

{{- define "k10.flrsessionImageRepo" -}}
  {{- if .Values.global.airgapped.repository }}
    {{- printf "%s/%s" .Values.global.airgapped.repository (include "k10.flrsessionImageName" .) }}
  {{- else if .Values.global.azMarketPlace }}
    {{- printf "%s/%s" .Values.global.azure.images.flrsession.registry .Values.global.azure.images.flrsession.image }}
  {{- else }}
    {{- printf "%s/%s" .Values.global.image.registry (include "k10.flrsessionImageName" .) }}
  {{- end }}
{{- end -}}

{{- define "k10.flrsessionImageName" -}}
  {{- printf "flrsession" }}
{{- end -}}

{{- define "k10.flrsessionImageTag" -}}
  {{- if .Values.global.azMarketPlace }}
    {{- print .Values.global.azure.images.flrsession.tag }}
  {{- else }}
    {{- include "get.k10ImageTag" . }}
  {{- end }}
{{- end -}}
