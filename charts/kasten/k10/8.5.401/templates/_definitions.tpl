...
{{- define "k10.statelessServices" -}}aggregatedapis auth bloblifecyclemanager controllermanager crypto dashboardbff events executor garbagecollector reporting repositories gateway state vbrintegrationapi{{- end -}}
...
{{- define "k10.kanisterToolsImageTag" -}}0.118.0{{- end -}}
