...
```bash
a) Get scripts by running: scripts/pull-ci-scripts
b) List and find your company name/chart by running: bin/partner-charts-ci list | grep <company>
...
#./ngrok http 8000
```
4. In Rancher UI create a test repository that points to your local "partner-charts" repo by selecting an appropriate cluster and going to Apps > Repositories and clicking "Create".  Enter a Name, copy ngrok forwarding url and paste into Target http(s) "Index URL" in Rancher UI and click 'Create' again.
